...
import (
	...
	camel "github.com/camel-tooling/camel-monitor-operator/pkg/client/camel/informers/externalversions/camel"
...
func (f *sharedInformerFactory) Camel() camel.Interface {
	return camel.New(f, f.namespace, f.tweakListOptions)
}
